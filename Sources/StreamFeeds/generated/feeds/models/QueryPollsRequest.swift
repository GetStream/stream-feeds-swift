...
public final class QueryPollsRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: QueryPollsRequest, rhs: QueryPollsRequest) -> Bool {
