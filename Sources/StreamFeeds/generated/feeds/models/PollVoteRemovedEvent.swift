...
public final class PollVoteRemovedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    public var type: String = "poll.vote_removed"
    ...
    public static func == (lhs: PollVoteRemovedEvent, rhs: PollVoteRemovedEvent) -> Bool {
        lhs.cid == rhs.cid &&
