...
public final class QueryFeedMembersRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: QueryFeedMembersRequest, rhs: QueryFeedMembersRequest) -> Bool {
