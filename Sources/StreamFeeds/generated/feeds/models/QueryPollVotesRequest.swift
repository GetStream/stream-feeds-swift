...
public final class QueryPollVotesRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: QueryPollVotesRequest, rhs: QueryPollVotesRequest) -> Bool {
