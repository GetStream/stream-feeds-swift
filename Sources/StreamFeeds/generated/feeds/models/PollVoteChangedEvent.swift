...
public final class PollVoteChangedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    public var type: String = "poll.vote_changed"
    ...
    public static func == (lhs: PollVoteChangedEvent, rhs: PollVoteChangedEvent) -> Bool {
        lhs.cid == rhs.cid &&
