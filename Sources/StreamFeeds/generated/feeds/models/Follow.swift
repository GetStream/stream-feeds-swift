...
public final class Follow: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    public var sourceFeed: Feed
    public var sourceFid: String
    public var status: String
    public var targetFeed: Feed
    public var targetFid: String
    public var updatedAt: Date

    public init(createdAt: Date, custom: [String: RawJSON]? = nil, pushPreference: String, request: Bool, requestAcceptedAt: Date? = nil, requestRejectedAt: Date? = nil, role: String? = nil, sourceFeed: Feed, sourceFid: String, status: String, targetFeed: Feed, targetFid: String, updatedAt: Date) {
    ...
    public static func == (lhs: Follow, rhs: Follow) -> Bool {
