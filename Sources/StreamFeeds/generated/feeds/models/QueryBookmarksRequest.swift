...
public final class QueryBookmarksRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: QueryBookmarksRequest, rhs: QueryBookmarksRequest) -> Bool {
